...
def test_get_account_when_logged_in(logged_in_page_username, test_web_address, db_connection):
    ...
    expect(p_tags).to_contain_text([
        "1 ticket for Placebo @ Brixton Academy, London on 2024-06-04 19:30",
        "4 tickets for Phantogram @ Corn Exchange, Cambridge on 2024-06-18 20:30"
    ])
...
def test_book_gig(logged_in_page_username, test_web_address, db_connection):
    ...
    expect(p_tags).to_contain_text([
        "1 ticket for Placebo @ Brixton Academy, London on 2024-06-04 19:30",
        "4 tickets for Phantogram @ Corn Exchange, Cambridge on 2024-06-18 20:30",
        "7 tickets for Portishead @ Brixton Academy, London on 2024-06-11 19:30"
    ])
